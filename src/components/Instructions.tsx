...
const Instructions = () => {
  return (
    <ParentContainer>
      ...
      <p>
        Each capstone project provides hands-on experience to strengthen skills
        in leadership, teamwork, communication, and problem-solving — essential
        for your success in the MEng program and beyond. Projects are designed
        to build both technical and leadership skills that are transferable
        across career paths.
      </p>
      <p>
      ...
      <p>
        ...
        (faculty-led vs. industry-sponsored). For more in-depth information, be
        sure to click on individual project links to explore detailed
      ...
      <ol className="list-decimal">
        ...
        <li>
          <span className="font-bold">Develop</span> a short list of your top 20
          or so preferences to help you begin to narrow down to your final 6 top
          choices.
        </li>
      </ol>
      <p>
